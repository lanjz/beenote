...
export const CATALOGS_REMOVE = 'CATALOGS_REMOVE'
export const CATALOGS_CUR_SAVE = 'CATALOGS_CUR_SAVE'
export const CATALOGS_CUR_BLOG = 'CATALOGS_CUR_BLOG'
...
export const CATALOGS_NOTE_MAP_SAVE = 'CATALOGS_NOTE_MAP_SAVE'

export const CATALOGS_CACHE_CLEAR = 'CATALOGS_CACHE_CLEAR'
export const CATALOGS_CACHE_SAVE = 'CATALOGS_CACHE_SAVE'
...
export const NOTE_CATALOGUE_SAVE = 'NOTE_CATALOGUE_SAVE'

// config

export const CONFIG_TOGGLE_SAVE = 'CONFIG_TOGGLE_SAVE'
export const CONFIG_EXTEND_SAVE = 'CONFIG_EXTEND_SAVE'
